...
if(isset($_POST['submit']) && CSRF::validateToken($_POST['token'])) {
    ...
    // Modified query to include the created_at column
    $statement = $pdo->prepare("INSERT INTO products(title, price, description, category, images, created_at) VALUES (?, ?, ?, ?, ?, CURRENT_TIMESTAMP)");
